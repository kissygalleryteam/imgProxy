 ...
 **/
KISSY.add('kg/imgProxy/2.0.0/index',function (S, Node,Base) {

    var SWF_FILE =  "http://a.tbcdn.cn/s/kissy/kg/imgProxy/2.0.0/ImgProxy.swf";
    var objWrapper, 
        loading = false,
        ready   = false,
        id = 0,
    ...
    function createSwf(idOrEl, vars) {
        ...
        var swfTpl ='<object data="__swfUrl" type="application/x-shockwave-flash" id="imgproxyMovie" name="imgproxyMovie" width="2.0.0%" height="2.0.0%">'+
